...
//  put your setup code here, to run once:
	DebugSerial.begin(9600);//ESPSerial.begin(115200);
	DebugSerial.sprintln("Start Setup:");
	
	StructInit(&PMS, &dht22, &CO, &TimeSend); DebugSerial.sprintln("Intitial Value: Done");
	...
	RGB_Init(A2,A1,A3);
	lcd.begin();
	DebugSerial.sprintln("Intitial ESP-SD-DHT-RGB-LCD: Done");
	...
	pms.wakeUp();	DebugSerial.sprintln("Intitial Dust Passive: Done");
  
 	lcd.setCursor(0,0);		lcd.print("--:-- PM2.5:----");
	lcd.setCursor(0,1);		lcd.print("t:-- h:-- CO:---");
	
	RTCAlarmInit();	 
	Timer1Init();	DebugSerial.sprintln("Intitial RTC-Timer: Done");
	DebugSerial.sprintln("End Setup....");
}
