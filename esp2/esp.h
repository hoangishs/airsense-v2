...
#define num_byte_data_from_arduino 26
#define num_byte_send_2_arduino 10
#define queue_size 10
#define debug false

#define f_front_rear_size 3
#define f_data_size 17
...
void enQueue(data _a)
{
    if(isQueueFull())
    {
        ...
        uint8_t _data[f_data_size]={0,0,0,0,save_data.temp,save_data.dot_temp,save_data.hum,save_data.dot_hum,save_data.pm1/256,save_data.pm1%256,save_data.dot_pm1,save_data.pm25/256,save_data.pm25%256,save_data.dot_pm25,save_data.pm10/256,save_data.pm10%256,save_data.dot_pm10};
...
void mqtt_begin()
{
    ...
    uint32_t a=macAddess[3]*256*256+macAddess[4]*256+macAddess[5];
